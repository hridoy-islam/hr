  ...
  return (
    <Card className="w-full shadow-lg">
      <CardContent className="space-y-4 p-4">
        ...
        {/* Attendance Info */}
        <div className="flex flex-wrap gap-12 text-sm text-gray-700 md:text-base px-2">
              ...
              <TableBody>
                {attendance.map((attendence) => (
                  <TableRow key={attendence._id}>
                    <TableCell>
                      {attendence?.userId?.title}{' '}
                      {attendence?.userId?.firstName}
                    </TableCell>
                    <TableCell>
                      {getShiftName(attendence?.userId?._id)}
                    </TableCell>
                    <TableCell>
