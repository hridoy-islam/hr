...
const ReviewStep = ({ formData, onSubmit, onBack, applicantData }) => {
  ...
  return (
    <div className="mx-auto w-full space-y-8 rounded-xl bg-white  px-6 py-10">
        ...
        <div className="grid grid-cols-1 gap-4 text-gray-700 md:grid-cols-2">
          <div>
            ...
            <p className="font-medium">
              {applicantData?.title} {applicantData?.firstName}{' '}
          ...
          <div>
            ...
            <p className="font-medium">
              {applicantData?.nationalInsuranceNumber || '-'}
            </p>
          </div>
          <div>
          ...
          <div>
            <p className="text-lg text-gray-500">Contact Hours</p>
            <p className="font-medium">{formData.GeneralInformation?.contractHours|| '-'}</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 text-gray-700 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="font-medium">
              {formatDate(applicantData?.availableFromDate)}
            </p>
          </div>
          <div>
            <p className="text-lg text-gray-500">Application Date</p>
            <p className="font-medium">
              {formatDate(applicantData?.applicationDate)}
            </p>
          </div>
          <div>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 text-gray-700 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="font-medium">
              {applicantData?.hasDisability ? 'Yes' : 'No'}
            </p>
          </div>
          {applicantData?.hasDisability && (
            <div>
              ...
              <p className="font-medium">
                {applicantData?.disabilityDetails || '-'}
              </p>
            </div>
          )}
          <div>
            ...
            <p className="font-medium">
              {applicantData?.needsReasonableAdjustment ? 'Yes' : 'No'}
            </p>
          </div>
          {applicantData?.needsReasonableAdjustment && (
            <div>
              ...
              <p className="font-medium">
                {applicantData?.reasonableAdjustmentDetails || '-'}
              </p>
            </div>
          )}
        </div>
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 text-gray-700 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {formData.GeneralInformation.payroll.payrollNumber || '-'}
                  </p>
                </div>
                ...
                {formData.GeneralInformation.payroll.paymentMethod ===
                  ...
                  <>
                    <div>
                      <p className="text-lg text-gray-500">Bank Name</p>
                      <p className="font-medium">
                        {formData.GeneralInformation.payroll.bankName || '-'}
                      </p>
                    </div>
                    <div>
                      <p className="text-lg text-gray-500">Account Number</p>
                      <p className="font-medium">
                        {formData.GeneralInformation.payroll.accountNumber ||
                          '-'}
                      </p>
                    </div>
                    <div>
                      <p className="text-lg text-gray-500">Sort Code</p>
                      <p className="font-medium">
                        {formData.GeneralInformation.payroll.sortCode || '-'}
                      </p>
                    </div>
                    <div>
                      <p className="text-lg text-gray-500">Beneficiary Name</p>
                      <p className="font-medium">
                        {formData.GeneralInformation.payroll.beneficiary || '-'}
                      </p>
                    </div>
                  </>
                )}
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 text-gray-700 md:grid-cols-2">
                <div>
                  <p className="text-lg text-gray-500">Full Name</p>
                  <p className="font-medium">
                    {formData.EqualityInformation.beneficiary.fullName || '-'}
                  </p>
                </div>
                <div>
                  <p className="text-lg text-gray-500">Relationship</p>
                  <p className="font-medium">
                    {formData.EqualityInformation.beneficiary.relationship ||
                      '-'}
                  </p>
                </div>
                <div>
                  <p className="text-lg text-gray-500">Email</p>
                  <p className="font-medium">
                    {formData.EqualityInformation.beneficiary.email || '-'}
                  </p>
                </div>
                <div>
                  <p className="text-lg text-gray-500">Mobile</p>
                  <p className="font-medium">
                    {formData.EqualityInformation.beneficiary.mobile || '-'}
                  </p>
                </div>
              </div>
            </section>
      ...
      <div className="flex justify-between gap-4 pt-6">
        <Button
          type="button"
          onClick={handleBack}
          className="rounded-md bg-black text-white transition hover:bg-black/90"
        >
          Back
        </Button>
        <Button
          type="button"
          onClick={onSubmit}
          className="rounded-md bg-supperagent text-white transition hover:bg-supperagent/90"
        >
          Submit
        </Button>
      </div>
