        ...
        <Card className="shadow-sm">
          <CardContent className="p-4 min-h-screen">
            ...
            <ListTodo className="h-8 w-8 text-theme" />
              ...
              <div className="flex w-full flex-col flex-wrap items-start gap-3 sm:flex-row md:w-auto md:items-end">
                ...
                <Button
                  ...
                  size="sm"
                  className="h-[38px] flex-1 border-none bg-theme text-white hover:bg-theme/90 sm:flex-none"
                >
